...
if (process.env.RPC_URL && process.env.CONTRACT_ADDRESS) {
	...
	} catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });
...
});        // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Auction not found" });          // Ensure only the owner can delete         if (auction.walletAddress.toLowerCase() !== req.user.walletAddress.toLowerCase()) {             return res.status(403).json({ error: "Unauthorized" });         }          await Auction.findByIdAndDelete(req.params.id);         await User.findByIdAndUpdate(req.user.id, { $inc: { totalCreated: -1 } });         res.json({ message: "Auction deleted" });     } catch (err) {         res.status(500).json({ error: err.message });     } });  } catch (err) {         res.status(500).json({ error: err.message });     } });  ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });         res.status(500).json({ error: err.message });     } });  // ── Socket.io Events ───────────────────────────────────────── io.on("connection", (socket) => {     socket.on("join_auction", (auctionId) => {         socket.join(`auction_${auctionId}`);     }); });  // ── Start Server ───────────────────────────────────────────── const PORT = process.env.PORT || 5000; server.listen(PORT, () => {     console.log(`🚀 BidMaster Server running on port ${PORT}`); });us(404).json({ error: "Not found" });
		const now = Date.now();
