// ── Must be first — fixes self-signed cert errors for local/dev blockchain nodes
...
=======
    ...
    try {
      ...
      console.warn("⚠️  Could not update userdata/users.json:", fsErr.message);
    }
...
// ═══════════════════════════════════════════════
<<<<<<< HEAD
//  START — Render requires binding to 0.0.0.0
// ═══════════════════════════════════════════════

const PORT = process.env.PORT || 5000;
server.listen(PORT, "0.0.0.0", () => console.log(`✅ Backend running on :${ PORT }`));
=======
//  GLOBAL ERROR GUARDS (prevent Render crashes)
// ═══════════════════════════════════════════════
